...
public class ELogEntity {
    ...
    private static ELogEntity instance;
    ...
    static void init(Context context) {
        ...
        instance = new ELogEntity(context);
    }

    private ELogEntity(Context context) {
        ...
        try {
            ...
            FwLog.write(Level.ERROR, "L-crash_main_ept-E", FwLog.stackToString(e));
        }
    }

    static ELogEntity getInstance() {
        if (instance == null) {
            throw new RuntimeException("ELogEntity.init() has not been called.");
        } else {
            return instance;
        }
    }
